...
自然演化產生的記憶生態，因果只是其中一層。

8 Layers:
1. Event Memory (事件)
2. Causal Memory (因果)
3. Policy Memory (策略)
4. Failure Archetype Memory (失敗原型)
5. Counterfactual Memory (反事實)
6. Value/Constraint Memory (價值/約束)
7. Self-Model Memory (自我模型)
8. Inheritance/Compression Memory (繼承/壓縮)
"""
