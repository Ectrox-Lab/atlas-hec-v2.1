...
def launch_universe(config):
    ...
    # Launch G1
    g1_cmd = f"cd {udir} && python3 ../../../implementations/g1/workload_continuous.py > g1.log 2>&1"
    g1_proc = subprocess.Popen(g1_cmd, shell=True)
    
    # Launch E1
    e1_cmd = f"cd {udir} && python3 ../../../implementations/e1/workload_continuous.py > e1.log 2>&1"
